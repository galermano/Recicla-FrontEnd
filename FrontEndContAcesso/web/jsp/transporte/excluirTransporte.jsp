...
<!-- Implementações estilos CSS -->
	...
	<title>Excluir Transporte</title>
</head>
<body>
	    <body>
        <div id="login">
                ...
                <div id="login-row" class="row justify-content-center align-items-center">
                    <div id="login-column" class="col-md-6">
                        <div id="login-box" class="col-md-12">
                            <h3 class="text-center text-white pt-5"><br>Excluir Transporte</h3>

                            <form id="login-form" class="form" action="validaExcluirTransporte.jsp" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="btn-login">
                                        ...
                                        <button id="entrar" type="submit" name="ENVIAR" value="ENVIAR" class="btn btn-info btn-md" >Excluir</button><br>
                                    </div>  
