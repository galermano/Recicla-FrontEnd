                ...
                <div id="login-row" class="row justify-content-center align-items-center">
                    <div id="login-column" class="col-md-6">
                        <div id="login-box" class="col-md-12">
                            ...
                            <form id="login-form" name="cadastrarTransporte" class="form" action="validaCadastrarTransporte.jsp" method="post">
                                    <div class="form-group">  
                                        <input type="text" name="PLACA"  id="PLACA" class="form-control" placeholder="Placa" autofocus required>
                                    </div>
                                    
                                    <div class="form-group">                             
                                        <input type="text" name="CAPACIDADE" id="CAPACIDADE" class="form-control" maxlenght="256px" placeholder="Capacidade" autofocus required>
                                    </div>
