<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
        <div id="cadasMaterial">
            <div class="container">
                <div id="cadasMaterial-row" class="row justify-content-center align-items-center">
                    <div id="cadasMaterial-column" class="col-md-6">
                        <div id="cadasMaterial-box" class="col-md-12">
                            <h4 class="text-center text-white pt-5">
                                <i class="fa fa-recycle" style="font-size: 80px; color: green"></i>
                                <br />Cadastre um Material
                            </h4>

                            <form id="cadasMaterial-form" class="form" action="validaInserirTipoMaterial.jsp" method="post">
                                <div class="form-group">
                                    <div class="form-group">
                                        <h6 class="titleInput">Nome Tipo Material</h6>
                                    ...
                                    <div class="form-group">
                                        <h6 class="titleInput">Especificação do Tipo Material</h6>
                                        <input type="text" name="ESPECIFICACAO" id="specifMaterial"
                                            class="form-control" placeholder="Reciclavel/Organico" autofocus required />
                                    </div>

                                    <div class="form-group">
                                        <h6>Descrição Tipo Material</h6>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" style="padding-top: 10%">
              
            <path fill="#808080" fill-opacity="1"
